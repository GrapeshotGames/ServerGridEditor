...
namespace ServerGridEditor
{
	 public partial class CreateIslandForm : Form
	 {
		  ...
		  private void Form2_Load(object sender, EventArgs e)
		  {
				...
				{
					 SpawnerTemplate.Items.Add(spawnerInfo.Name);
				}
		  ...
		  private void createBtn_Click(object sender, EventArgs e)
		  {
				...
				else
				{
					 ...
					 mainForm.islands.Add(Name, new Island(Name, x, y, newImgPath, landscapeMaterialOverride, sublevelNames, spawnerOverrides,
						  ...
						  prioritizeVolumesForTreasuresChkBox.Checked,
						  isControlPointChkBox.Checked, isControlPointAllowCaptureChckBox.Checked, IslandTreasureBottleSupplyCrateOverridesTxtBox.Text,
						  new List<string>(extraSublevelsTxtBox.Lines), islandPoints, spSpawnPointX, spSpawnPointY, spSpawnPointZ, maxIslandZ));
